...
enumclawTSObj <- cefa_load(nwsID = 451702, meta = meta)
...
enumclawData_2005 <-raws_getData(enumclawTSObj_2005, forOpenair = TRUE)
enumclawData_200508 <-raws_getData(enumclawTSObj_2005, forOpenair = TRUE)
