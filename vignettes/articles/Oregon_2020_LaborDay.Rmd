...
```{r windRosesOGOO, echo = FALSE, message = FALSE, fig.width = 5, fig.height = 5, fig.show = 'hold', fig.align = 'center'}
...
fw13Plot <- openair::windRose(fw13Data_orOGOO, ws = "windSpeed", wd = "windDirection", main = "Goodwin peak, September 2005-2017.")
wrccPlot <- openair::windRose(orOGOOData, ws = "windSpeed", wd = "windDirection", main = "Goodwin peak, September 2020.")
